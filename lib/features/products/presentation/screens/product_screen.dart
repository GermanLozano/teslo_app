...
// esta clase va a servir tanto para crear como para actualizar productos
...
// creamos solo la vista para el producto 
      ...
      child: Column(
        ...
        children: [
          ...
          CustomProductField( 
            ...
            onChanged: ref.read(productFormProvider(product).notifier).onDescripcionChanged,
          ),
...
class _SizeSelector extends StatelessWidget {
  ...
  final void Function(List<String> selectedSize) onSizesChanged;
  ...
  Widget build(BuildContext context) {
    ...
    return PageView(
      ...
      children: images.map((image){
          ...
          // cambiamos la referencia de un networkimage a un file 
